...
foreach($groups as $group)
{
	echo '<br /><br /><strong>Question Group ' . $i . '</strong>&nbsp;<img src="/images/delete.gif" width="15" height="15" />Delete<br /><br />Question Group Header:
	<br /><input type="text" size="200" value="'.$group['title'].'" name="group-'.$group['id'].'-name"/><ul style="background-color:gray;border-style:solid;border-color:black">';
	
	$j = 1;
	foreach($group['questions'] as $question)
	{
		echo '<li style="background-color:green;color:white;border-style:solid;border-color:black">Question ' . $j . '&nbsp;<img src="/images/delete.gif" width="15" height="15" />Delete<br  />Text:';
		...
		foreach($question['options'] as $option)
		{
			echo '<br /><br /><li style="background-color:red;color:black;border-style:solid;border-color:black">Question ' . $j . ' - Answer ' . $k . '&nbsp;<img src="/images/delete.gif" width="15" height="15" />Delete<br />';
...
<br /><input type="submit" value="Submit Changes" name="submit" />
</form>
...
<script type = "text/javascript">
            ...
            {
                  var new_field =
                  "<br /><br /><strong>Question Group " + num_groups + "</strong>&nbsp;<img src='/images/delete.gif' width='15' height='15' />Delete<br /><br />Question Group Header:"+
            ...
            function addOption(field)
            {
                ...
                var new_field =
                '<br /><li style="background-color:red;color:black;border-style:solid;border-color:black">Question ' + viewquestion + ' - Answer ' + viewoption + '&nbsp;<img src="/images/delete.gif" width="15" height="15" />Delete<br />'
            ...
            function addQuestion(field)
            {
                ...
                var new_field = '<br /><li style="background-color:green;color:black;border-style:solid;border-color:black">Question ' + viewquestion + '&nbsp;<img src="/images/delete.gif" width="15" height="15" />Delete<br />Text:'
